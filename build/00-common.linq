...
static ProjectVersion[] Projects = new[]
{
	...
	new ProjectVersion("Sdcb.PaddleInference", "3.3.1"),
	new ProjectVersion("Sdcb.PaddleOCR", "3.3.1"),
	new ProjectVersion("Sdcb.PaddleOCR.Models.Online", "3.3.1"),
	new ProjectVersion("Sdcb.PaddleOCR.Models.Local", "3.3.1"),
	//new ProjectVersion("Sdcb.PaddleOCR.Models.Shared", "3.0.0"),
	new ProjectVersion("Sdcb.PaddleOCR.Models.LocalV5", "3.3.1"),
	//new ProjectVersion("Sdcb.PaddleDetection", "2.3.3.1"),
	//new ProjectVersion("Sdcb.RotationDetector", "1.1.0"),
	new ProjectVersion("Sdcb.PaddleNLP.Lac", "1.1.0"),
